// NOTE: This file mirrors the canvas content and is set as a client component.
"use client";
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <Button className="rounded-2xl">
              <span className="inline-flex items-center"><CalendarDays className="mr-2 size-4"/>Prendre RDV</span>
            </Button>
          </div>
        </div>
      </nav>
          ...
          <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.6}}>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">
              <Button className="rounded-2xl text-base px-6 py-6">
                <span className="inline-flex items-center"><CalendarDays className="mr-2 size-4"/>Demander un devis</span>
              </Button>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="mt-6 space-y-4" aria-label="Formulaire de contact">
              ...
              <Button type="submit" className="rounded-2xl">
                <span className="inline-flex items-center"><Send className="size-4 mr-2"/>Envoyer</span>
              </Button>
            </form>
          </div>
